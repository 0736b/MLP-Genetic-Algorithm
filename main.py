...
def main():
    ...
    for i in range(folds):
        ...
        st = time.time()
        ga = GA(20, train_folds[i], 100, [30, 16, 8, 1])
        ...
        path_model = 'models/30-16-8-1/best_fold_' + str(i+1) + '.data'
        path_mse_avg = 'models/30-16-8-1/ga/mse_avg_fold_' + str(i+1) + '.data'
        path_mse_best = 'models/30-16-8-1/ga/mse_best_fold_' + str(i+1) + '.data'
